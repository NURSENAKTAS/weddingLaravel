...
class RezervasyonSeeder extends Seeder
{
    /**
    ...
    {
        $jsonData = $this->getDecode("rezervasyon"); //json formatından çöz ve jsonData adlı değişkene verileri at
        foreach ($jsonData as $data)
        {
            Rezervasyonlar::create([
                'id' => $data->id,
                'randevu_id' => $data->randevu_id,
                'rezervasyon_durum' => $data->rezervasyon_durumu,
